...
2. Changer les fichier dams k8s pour que la configuration namespace soit "dev"

3. Modifier le fichier config.yaml et changer tous les instace des mot "my-k8s-app:latest" pour "my-k8s-app:dev"
...
8.  Refaites les étape de 1 à 7, mais pour l'environnement de qa (donc branchez vous du la branche qa et changer les configurations de dev à qa)
